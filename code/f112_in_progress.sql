...
--   Application:     112
--   Name:            DI_MGR
--   Date and Time:   20:03 Friday February 25, 2011
--   Exported By:     ADMIN
--   Flashback:       0
...
wwv_flow_api.create_flow(
  ...
  p_checksum_salt_last_reset => '20110225195554',
...
wwv_flow_api.create_page(
  ...
  p_required_patch=> null + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'ADMIN',
  p_last_upd_yyyymmddhh24miss => '20110225155814',
  p_page_comment  => '');
...
wwv_flow_api.create_page(
  ...
  p_required_patch=> null + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'ADMIN',
  p_last_upd_yyyymmddhh24miss => '20110218173212',
  p_page_is_public_y_n=> 'N',
  p_page_comment  => '');
...
':P4_OWNERS, :P4_SELECT_TABLE, :P4_RESTABLE_OWNER, :P4_RESTABLE_NAME);'||chr(10)||
'end;';
...
wwv_flow_api.create_page(
  ...
  p_required_patch=> null + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'ADMIN',
  p_last_upd_yyyymmddhh24miss => '20110218180152',
  p_page_is_public_y_n=> 'N',
  p_page_comment  => '');
...
wwv_flow_api.create_page_computation(
  ...
  p_computation_processed=> 'REPLACE_EXISTING',
  p_computation=> 'select replace(:P5_CONSTRAINT_VALIDATION_QRY,'';'')'||chr(10)||
'from dual',
  p_required_patch=> null + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page(
  ...
  p_required_patch=> null + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'ADMIN',
  p_last_upd_yyyymmddhh24miss => '20110218181157',
  p_page_is_public_y_n=> 'N',
  p_page_comment  => '');
...
wwv_flow_api.create_page_button(
  ...
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
  p_button_alignment=> 'RIGHT',
  p_button_condition=> 'P6_CREATE_MODE_IS_ON',
...
wwv_flow_api.create_page_computation(
  ...
  p_computation_type=> 'QUERY',
  p_computation_processed=> 'REPLACE_EXISTING',
  p_computation=> 'select replace(:P6_CONSTRAINT_VALIDATION_QRY,'';'')'||chr(10)||
'from dual',
  p_required_patch=> null + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page(
  ...
  p_required_patch=> null + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'ADMIN',
  p_last_upd_yyyymmddhh24miss => '20110218173148',
  p_page_is_public_y_n=> 'N',
  p_page_comment  => '');
...
':P7_OWNERS, :P7_SELECT_TABLE, :P7_RESTABLE_OWNER, :P7_RESTABLE_NAME);'||chr(10)||
'end;';
...
wwv_flow_api.create_page(
  ...
  p_required_patch=> null + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'ADMIN',
  p_last_upd_yyyymmddhh24miss => '20110218173241',
  p_page_is_public_y_n=> 'N',
  p_page_comment  => '');
...
':P8_OWNERS, :P8_SELECT_TABLE, :P8_RESTABLE_OWNER, :P8_RESTABLE_NAME);'||chr(10)||
'end;';
...
wwv_flow_api.create_page(
  ...
  p_required_patch=> null + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'ADMIN',
  p_last_upd_yyyymmddhh24miss => '20110218174424',
  p_page_is_public_y_n=> 'N',
  p_page_comment  => '');
...
wwv_flow_api.create_page_computation(
  ...
  p_computation_type=> 'QUERY',
  p_computation_processed=> 'REPLACE_EXISTING',
  p_computation=> 'select replace(:P9_CONSTRAINT_VALIDATION_QRY,'';'')'||chr(10)||
'from dual',
  p_required_patch=> null + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page(
  ...
  p_required_patch=> null + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'ADMIN',
  p_last_upd_yyyymmddhh24miss => '20110218173810',
  p_page_is_public_y_n=> 'N',
  p_page_comment  => '');
